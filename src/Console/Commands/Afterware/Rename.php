...
class Rename extends Command
{
    ...
    public function run(array $params, array $options = []): void
    {
        ...
        $old_namespace = "namespace App\\Afterware{$old_parts['namespace']}";
        $new_namespace = "namespace App\\Afterware{$new_parts['namespace']}";
        ...
        if ($content === false) {
            $this->error("Failed to Read Old Afterware: [{$old}]");
            return;
        }
        ...
        if (!File::pop($old_file)) {
            $this->error("Failed to Remove Old Afterware: [$old_file]!");
            return;
        }
