...
throw new \Exception("Path: ". (string) APP_PATH);
####################################################################################
/*--------------------------------- RELAY LOADER ---------------------------------*/
####################################################################################
...
$autoDiscoverJsonFile = realpath(APP_PATH . '/vendor/composer/installed.json');
...
$appProviderDir = realpath(APP_PATH . '/lf-app/Provider');
